...
* @returns {any}
*/
export function setup_unsafe() {
    const ret = wasm.setup_unsafe();
...
* @returns {any}
*/
export function commit(ckey_bytes_1, ckey_bytes_2, x) {
    const ptr0 = passArray8ToWasm0(ckey_bytes_1, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(ckey_bytes_2, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.commit(ptr0, len0, ptr1, len1, x);
    return takeObject(ret);
}
...
* @returns {any}
*/
export function encrypt(ckey_bytes_1, ckey_bytes_2, commit, y, message) {
    const ptr0 = passArray8ToWasm0(ckey_bytes_1, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(ckey_bytes_2, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray8ToWasm0(commit, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.encrypt(ptr0, len0, ptr1, len1, ptr2, len2, y, message);
    return takeObject(ret);
}
...
* @returns {number}
*/
export function decrypt(ckey_bytes_1, ckey_bytes_2, proj_key_bytes, rand_bytes, ciphertext, x, r_commit_bytes) {
    const ptr0 = passArray8ToWasm0(ckey_bytes_1, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(ckey_bytes_2, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray8ToWasm0(proj_key_bytes, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passArray8ToWasm0(rand_bytes, wasm.__wbindgen_malloc);
    const len3 = WASM_VECTOR_LEN;
    const ptr4 = passArray8ToWasm0(r_commit_bytes, wasm.__wbindgen_malloc);
    const len4 = WASM_VECTOR_LEN;
    const ret = wasm.decrypt(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ciphertext, x, ptr4, len4);
    return ret;
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('witness_encryption_functional_commitment_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
